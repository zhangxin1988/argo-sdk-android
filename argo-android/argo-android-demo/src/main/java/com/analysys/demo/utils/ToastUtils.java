package com.analysys.demo.utils;
...
public class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        show(AnsApplication.getApp().getResources().getText(resId).toString(), duration);
    }

    private static void show(final int resId, final int duration, final Object... args) {
        show(String.format(AnsApplication.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(AnsApplication.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(AnsApplication.getApp());
                sToast.setView(view);
    ...
    private static View getView(final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) AnsApplication.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
